...
type listFn func(ctx context.Context, prefix string, recursive bool,
	cb func(ctx context.Context, path string, content *manifest.Content) error) error

func collectPaths(list listFn, prefix string, recursive bool) (rv []string) {
	err := list(ctx, prefix, recursive,
